...
role:
  ...
  output_contract: "File .opencode/prompts/{feature}.md + handoff_output payload for plan-review"
...
## OUTPUT
output:
  file: ".opencode/prompts/{feature-name}.md"
  format: |
    Plan created: .opencode/prompts/{feature-name}.md
  ...
  handoff_output:
    ...
    example: |
      Handoff → /plan-review:
        artifact: .opencode/prompts/{feature}.md
        ...
        spec_artifact: ".opencode/prompts/{feature}-spec.md"  # if applicable
...
startup:
  ...
  mandatory_steps:
    - step: 0
      ...
      files:
        - ".opencode/skills/planner-rules/SKILL.md"
      purpose: "Load planner-rules skill for task classification and routing overview."
    ...
    - step: 0.5
      ...
      check: "If --spec provided OR .opencode/prompts/{feature}-spec.md exists"
    ...
    - step: 2
      action: Read
      file: ".opencode/templates/plan-template.md"
...
phases:
    ...
    steps:
      - step: "Investigate code"
        ...
        complex_search:
          ...
          note: "code-researcher returns structured summary ≤2000 tokens. See .opencode/agents/code-researcher.md for output format."
  ...
  phase_4_design:
    ...
    sequential_thinking:
      reference: ".opencode/skills/planner-rules/sequential-thinking-guide.md"
