...
## OUTPUT
output:
  description: "Working code passing VERIFY (adapt to project — SEE .opencode/PROJECT-KNOWLEDGE.md)"
...
startup:
  immediate_actions:
    - action: "Load MCP patterns and coder-rules skill"
      files:
        - ".opencode/skills/coder-rules/SKILL.md"
      purpose: "Load coder-rules skill for 5 CRITICAL rules and evaluate protocol."

    - action: "Read .opencode/prompts/{feature-name}.md"
      purpose: "Load plan"

    - action: "Conditional: Load TDD skill"
      condition: "Plan file contains '## TDD' heading"
      files:
        - ".opencode/skills/tdd-go/SKILL.md"
    ...
    - action: "Conditional: Load Review Response protocol"
      ...
      files:
        - ".opencode/skills/coder-rules/review-response.md"
    ...
    - action: "Load Spec Check protocol"
      files:
        - ".opencode/skills/coder-rules/spec-check.md"
...
workflow:
  ...
  phases:
    - phase: 0.5
      ...
      reference: ".opencode/skills/coder-rules/review-response.md"
      steps:
    ...
    - phase: 1
      name: "READ PLAN"
      steps:
        - "Read .opencode/prompts/{feature-name}.md"
    ...
    - phase: 1.5
      ...
      research_assist:
        tool: "Task (code-researcher agent)"
      ...
      evaluate_output:
        ...
        file: ".opencode/prompts/{feature}-evaluate.md"
        format: |
          ## Evaluate Result

          **Decision:** PROCEED | REVISE | RETURN
          **Plan:** .opencode/prompts/{feature}.md
    ...
    evaluate_to_implement_gate:
      ...
      action: |
        ...
        .opencode/prompts/{feature}-evaluate.md (already required)
    ...
    - phase: 2
      ...
      tdd_mode:
        ...
        reference: ".opencode/skills/tdd-go/SKILL.md § Integration with Coder Parts"
    ...
    - phase: 3
      ...
      verify_startup:
        ...
        note: "AGENTS.md defines defaults. PROJECT-KNOWLEDGE.md overrides. This ensures VERIFY never fails due to missing build tooling."
    ...
    - phase: 3.5
      ...
      reference: ".opencode/skills/coder-rules/spec-check.md"
      steps:
